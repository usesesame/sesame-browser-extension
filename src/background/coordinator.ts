...
// The shared fill choreography, described as data. Each surface declares how it
// resolves its page, inspects, prepares, asks the desktop for approval, writes,
// and cleans up; one pipeline owns stage order, the binding token, abort checks,
// page re-verification, and clear-in-finally — so no surface can ship without them.
...
// Cards may only ever be written onto an https page.
